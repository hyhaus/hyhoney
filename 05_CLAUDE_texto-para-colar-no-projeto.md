# 05 · CLAUDE.md — texto para colar no projeto HyHoney

> Copie tudo abaixo da linha para um arquivo chamado `CLAUDE.md` na raiz da pasta HyHoney (ou nas instruções do projeto no app do Claude). É o "bilhete na geladeira" que toda sessão lê antes de começar.
