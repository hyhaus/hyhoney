// HyHoney v1 — cache simples para abrir offline
const C='hyhoney-v2';const FILES=['/','/index.html','/icones/manifest.webmanifest','/icones/icon-192.png','/icones/icon-512.png'];
